...
export const REACT_APP_MAP_EXTENSION_CONTRIBUTION_ROUTES = (window._env_
  ?.REACT_APP_MAP_EXTENSION_CONTRIBUTION_ROUTES ||
  import.meta.env.REACT_APP_MAP_EXTENSION_CONTRIBUTION_ROUTES ||
  window._env_?.REACT_APP_MAP_LAYER_CONTRIBUTION_ROUTES ||
