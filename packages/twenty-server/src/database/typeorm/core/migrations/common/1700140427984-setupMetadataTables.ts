...
export class SetupMetadataTables1700140427984 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "core"."indexMetadata_indextype_enum" AS ENUM('BTREE', 'GIST', 'GIN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "core"."viewFilter_operand_enum" AS ENUM('IS', 'IS_NOT_NULL', 'IS_NOT', 'LESS_THAN_OR_EQUAL', 'GREATER_THAN_OR_EQUAL', 'IS_BEFORE', 'IS_AFTER', 'CONTAINS', 'DOES_NOT_CONTAIN', 'IS_EMPTY', 'IS_NOT_EMPTY', 'IS_RELATIVE', 'IS_IN_PAST', 'IS_IN_FUTURE', 'IS_TODAY', 'VECTOR_SEARCH', 'WITHIN_DISTANCE', 'WITHIN_BBOX', 'INTERSECTS', 'CONTAINS_GEOMETRY', 'WITHIN_GEOMETRY', 'NEAR')`,
    );
    await queryRunner.query(
